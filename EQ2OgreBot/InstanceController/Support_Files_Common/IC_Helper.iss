...
function CastInterrupt(bool Group=TRUE)
{
	...
	if ${Group}
	{
		...
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+berserker "Mock"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+guardian "Provoke"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+shadowknight "Blasphemy"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+paladin "Judgment"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+bruiser "Sonic Punch"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+monk "Challenge"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+ranger "Hilt Strike"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+assassin "Hilt Strike"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+dirge "Hymn of Horror"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+troubador "Breathtaking Bellow"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+swashbuckler "Tease"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+brigand "Cuss"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+beastlord "Sharpened Claws"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+coercer "Hemorrhage"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+coercer "Spellblade's Counter"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+conjuror "Winds of Velious"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+illusionist "Chromatic Storm"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+necromancer "Dooming Darkness"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+necromancer "Grasping Bones"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+warlock "Nullify"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+wizard "Cease"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+mystic "Echoes of the Ancients"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+mystic "Scourge"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+defiler "Absolute Corruption"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+fury "Maddening Swarm"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+warden "Willow Wisp"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+channeler "Shadow Bind"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+inquisitor "Invocation"
		oc !ci -CastAbilityNoChecks igw:${Me.Name}+templar "Rebuke"
		; Resume Ogre
		oc !ci -Resume igw:${Me.Name}
	}
	...
	else
	{
		...
		oc !ci -CastAbilityNoChecks ${Me.Name}+berserker "Mock"
		oc !ci -CastAbilityNoChecks ${Me.Name}+guardian "Provoke"
		oc !ci -CastAbilityNoChecks ${Me.Name}+shadowknight "Blasphemy"
		oc !ci -CastAbilityNoChecks ${Me.Name}+paladin "Judgment"
		oc !ci -CastAbilityNoChecks ${Me.Name}+bruiser "Sonic Punch"
		oc !ci -CastAbilityNoChecks ${Me.Name}+monk "Challenge"
		oc !ci -CastAbilityNoChecks ${Me.Name}+ranger "Hilt Strike"
		oc !ci -CastAbilityNoChecks ${Me.Name}+assassin "Hilt Strike"
		oc !ci -CastAbilityNoChecks ${Me.Name}+dirge "Hymn of Horror"
		oc !ci -CastAbilityNoChecks ${Me.Name}+troubador "Breathtaking Bellow"
		oc !ci -CastAbilityNoChecks ${Me.Name}+swashbuckler "Tease"
		oc !ci -CastAbilityNoChecks ${Me.Name}+brigand "Cuss"
		oc !ci -CastAbilityNoChecks ${Me.Name}+beastlord "Sharpened Claws"
		oc !ci -CastAbilityNoChecks ${Me.Name}+coercer "Hemorrhage"
		oc !ci -CastAbilityNoChecks ${Me.Name}+coercer "Spellblade's Counter"
		oc !ci -CastAbilityNoChecks ${Me.Name}+conjuror "Winds of Velious"
		oc !ci -CastAbilityNoChecks ${Me.Name}+illusionist "Chromatic Storm"
		oc !ci -CastAbilityNoChecks ${Me.Name}+necromancer "Dooming Darkness"
		oc !ci -CastAbilityNoChecks ${Me.Name}+necromancer "Grasping Bones"
		oc !ci -CastAbilityNoChecks ${Me.Name}+warlock "Nullify"
		oc !ci -CastAbilityNoChecks ${Me.Name}+wizard "Cease"
		oc !ci -CastAbilityNoChecks ${Me.Name}+mystic "Echoes of the Ancients"
		oc !ci -CastAbilityNoChecks ${Me.Name}+mystic "Scourge"
		oc !ci -CastAbilityNoChecks ${Me.Name}+defiler "Absolute Corruption"
		oc !ci -CastAbilityNoChecks ${Me.Name}+fury "Maddening Swarm"
		oc !ci -CastAbilityNoChecks ${Me.Name}+warden "Willow Wisp"
		oc !ci -CastAbilityNoChecks ${Me.Name}+channeler "Shadow Bind"
		oc !ci -CastAbilityNoChecks ${Me.Name}+inquisitor "Invocation"
		oc !ci -CastAbilityNoChecks ${Me.Name}+templar "Rebuke"
		; Resume Ogre
