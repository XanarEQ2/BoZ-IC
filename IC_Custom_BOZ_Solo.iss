...
; Starts Instance Controller and loads Custom BoZ Solo zones
...
function main()
{
	...
	; Set to Custom/_Exp_20_Ballads_of_Zimara/Solo folder
	Ogre_Instance_Controller:Set_CurrentDirectory["Custom/_Exp_20_Ballads_of_Zimara/Solo"]
