...
; Starts Instance Controller and loads Custom BoZ Chrono zones
...
function main()
{
	...
	; Set to Custom/_Exp_20_Ballads_of_Zimara/Chrono folder
	Ogre_Instance_Controller:Set_CurrentDirectory["Custom/_Exp_20_Ballads_of_Zimara/Chrono"]
